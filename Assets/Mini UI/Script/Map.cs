        ...
        IDragHandler
{
    ...
    [SerializeField]
    private RectTransform Viewport_Dimensions;
    ...
    void Start()
    {
        ...
        Half_Map_Background_Dimensions = new Vector2(
            (Map_Background_Dimensions.rect.width / 2),
            (Map_Background_Dimensions.rect.height / 2)
        );
        Half_Viewport_Dimensions = new Vector2(
            (Viewport_Dimensions.rect.width / 2),
            (Viewport_Dimensions.rect.height / 2)
        );
    ...
    void Update()
    {
        Map_Background_Dimensions.anchoredPosition = new Vector2(
            Mathf.Clamp(
                Map_Background_Dimensions.anchoredPosition.x,
                -HorizontalPixel,
                HorizontalPixel
            ),
            Mathf.Clamp(Map_Background_Dimensions.anchoredPosition.y, -VerticalPixel, VerticalPixel)
        );
    }
}
