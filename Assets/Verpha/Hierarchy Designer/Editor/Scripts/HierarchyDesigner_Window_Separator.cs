...
namespace Verpha.HierarchyDesigner
{
    public class HierarchyDesigner_Window_Separator : EditorWindow
    {
        ...
        private Color newTextColor = HierarchyDesigner_Configurable_DesignSettings.SeparatorDefaultTextColor;
        private bool newIsGradient = HierarchyDesigner_Configurable_DesignSettings.SeparatorDefaultIsGradientBackground;
        private Color newBackgroundColor = HierarchyDesigner_Configurable_DesignSettings.SeparatorDefaultBackgroundColor;
        private Gradient newBackgroundGradient = HierarchyDesigner_Configurable_DesignSettings.SeparatorDefaultBackgroundGradient;
        private int newFontSize = HierarchyDesigner_Configurable_DesignSettings.SeparatorDefaultFontSize;
        private FontStyle newFontStyle = HierarchyDesigner_Configurable_DesignSettings.SeparatorDefaultFontStyle;
        private TextAnchor newTextAnchor = HierarchyDesigner_Configurable_DesignSettings.SeparatorDefaultTextAnchor;
