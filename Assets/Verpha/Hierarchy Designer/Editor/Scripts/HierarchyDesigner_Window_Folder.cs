...
namespace Verpha.HierarchyDesigner
{
    public class HierarchyDesigner_Window_Folder : EditorWindow
    {
        ...
        private Color newTextColor = HierarchyDesigner_Configurable_DesignSettings.FolderDefaultTextColor;
        private int newFontSize = HierarchyDesigner_Configurable_DesignSettings.FolderDefaultFontSize;
        private FontStyle newFontStyle = HierarchyDesigner_Configurable_DesignSettings.FolderDefaultFontStyle;
