...
namespace Verpha.HierarchyDesigner
{
    public class HierarchyDesigner_Window_Presets : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            applyToFolderDefaultValues = HierarchyDesigner_Shared_GUI.DrawToggle("Folder Default Values", toggleLabelWidth, applyToFolderDefaultValues);
            applyToSeparatorDefaultValues = HierarchyDesigner_Shared_GUI.DrawToggle("Separator Default Values", toggleLabelWidth, applyToSeparatorDefaultValues);
