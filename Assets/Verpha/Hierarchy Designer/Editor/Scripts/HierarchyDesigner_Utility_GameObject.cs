...
namespace Verpha.HierarchyDesigner
{
    ...
    {
        #region Context menu
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Refresh + "/Refresh All GameObjects' Data", false, HierarchyDesigner_Shared_MenuItems.LayerEighteen)]
        public static void ContextMenu_Refresh_AllGameObjectsData() => RefreshAllGameObjectsData();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Refresh + "/Refresh Selected GameObject's Data", false, HierarchyDesigner_Shared_MenuItems.LayerEighteen)]
        public static void ContextMenu_Refresh_SelectedGameObjectsData() => RefreshSelectedGameObjectsData();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Refresh + "/Refresh Selected Main Icon", false, HierarchyDesigner_Shared_MenuItems.LayerNineteen)]
        public static void ContextMenu_Refresh_SelectedMainIcon() => RefreshMainIconForSelectedGameObject();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Refresh + "/Refresh Selected Component Icons", false, HierarchyDesigner_Shared_MenuItems.LayerNineteen + 1)]
        public static void ContextMenu_Refresh_SelectedComponentIcons() => RefreshComponentIconsForSelectedGameObjects();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Refresh + "/Refresh Selected Hierarchy Tree Icon", false, HierarchyDesigner_Shared_MenuItems.LayerNineteen + 1)]
        public static void ContextMenu_Refresh_SelectedHierarchyTreeIcon() => RefreshHierarchyTreeIconForSelectedGameObjects();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Refresh + "/Refresh Selected Tag", false, HierarchyDesigner_Shared_MenuItems.LayerNineteen + 1)]
        public static void ContextMenu_Refresh_SelectedTag() => RefreshTagForSelectedGameObjects();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Refresh + "/Refresh Selected Layer", false, HierarchyDesigner_Shared_MenuItems.LayerNineteen + 2)]
