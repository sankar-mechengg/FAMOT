...
namespace Verpha.HierarchyDesigner
{
    public class HierarchyDesigner_Utility_Separator
    {
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Separators + "/Transform Separator into a GameObject", false, HierarchyDesigner_Shared_MenuItems.LayerOne + 1)]
        public static void ContextMenu_Separator_TransformSeparatorIntoAGameObject() => TransformSeparatorIntoAGameObject();
        #endregion
        ...
        private static void TransformSeparatorIntoAGameObject()
        {
            GameObject selectedObject = Selection.activeGameObject;
            if (selectedObject == null)
            {
